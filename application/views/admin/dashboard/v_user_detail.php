    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="active tab-pane" id="activity">
                ...
                <div class="col-xs-6">
                <?php foreach ($detail as $row) { ?>
                <form class="form" action="<?php echo site_url('admin/dashboard/proses_edit_foto') ?>" enctype="multipart/form-data" method="post">
                ...
                <div class="col-xs-6">
                <form action="<?php echo site_url('admin/dashboard/ambil_user') ?>" method="post">
