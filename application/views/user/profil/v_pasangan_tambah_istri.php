        ...
        <div class="col-md-9">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                <div class="post">              
                <form action="<?php echo site_url('user/profil/cari_pasangan_istri')?>" method = "GET">
                <input type="hidden" class="form-control" name="jenis_permintaan" value="Istri">
                <div class="form-group">
                    <label for="cari">Masukkan Nama Istri</label>
                    <div class="input-group margin">
                        <input type="text" class="form-control" placeholder="Masukkan Nama Istri" name="cari" id="cari" required>
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="submit"><i class="fa fa-search"> Cari Istri</i></button>
                        </span>
                    </div>          
                </div>
                </form>
            ...
            <?php if(empty($cari)){ 
                ...
                <div class="col-sm-offset-2 col-sm-12">
                    ...
                    <form action="<?php echo site_url('user/profil/proses_tambah_pasangan_manual'); ?>" method="POST">
                        <button class="btn btn-default btn-block btn-flat">Masukkan Biodata Istri Anda</button>
                        <input type="hidden" class="form-control" name="jenis_permintaan" value="Istri">
                        ...
                        <tr>
                            <td><h5></h5></td>
                            <td>
                            <button class="btn btn-default btn-sm"><i class="fa fa-plus"> Tambah Istri</i> </button>
                            </td>
                        </tr>
                        </table>
                    </form>
                ...
                <?php foreach ($cari as $data) { ?>
                    <tr>
                        ...
                        <input type="hidden" class="form-control" name="id" value="<?php echo $data->id; ?>">
                        <input type="hidden" name="jenis_permintaan_istri" value="Istri">
                        <td width="10%"><button class="btn btn-default btn-sm"><i class="fa fa-plus"> Tambah Istri</i> </button>
                        </td>
                        </form>
                    </tr>
                    </div>
