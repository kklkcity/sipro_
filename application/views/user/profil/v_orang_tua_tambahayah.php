        ...
        <div class="col-md-9">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                <div class="post">              
                <form action="<?php echo site_url('user/profil/cari_orang_tua_ayah')?>" method = "GET">
                <div class="form-group">
                    <label for="cari">Masukkan Nama Ayah</label>
                    <div class="input-group margin">
                        <input type="text" class="form-control" placeholder="Masukkan Nama Pasangan" name="cari" id="cari" required>
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="submit"><i class="fa fa-search"> Cari Ayah</i></button>
                        </span>
                    </div>          
                </div>
                </form>
                ...
                <?php foreach ($cari as $data) { ?>
                    <tr>
                        ...
                        <input type="hidden" class="form-control" name="id" value="<?php echo $data->id; ?>">
                        <input type="hidden" class="form-control" name="jenis_permintaan_ayah" value="Ayah">
                        <td width="10%"><button class="btn btn-default btn-sm"></i><i class="fa fa-plus"></i> Tambah Ayah </button></td>
                        </form>
                    </tr>
                    </div>
                    <?php  } } ;?>    
