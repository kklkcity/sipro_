...
<body class="login-page">
            ...
            <div class="panel-heading" align="center" style="font-size:20px"><b>Lengkapi Data Profilmu</b></div>
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_3" data-toggle="tab">Pasangan</a></li>
                    </ul>
                   ...
                   <div class="tab-pane" id="tab_2">
                    ...
                    <div class="tab-pane" id="tab_3">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Nama Pasangan</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_lengkap" >
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url(); ?>assets/new/vendors/nprogress/nprogress.js"></script>
    <script src="<?php echo base_url(); ?>assets/new/vendors/jQuery-Smart-Wizard/js/jquery.smartWizard.js"></script>
