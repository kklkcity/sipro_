...
class Dashboard extends CI_Controller {
    ...
    Public function index()
    {
        ...
        $data['user'] = $this->m_dashboard->ambil_semua_user();
        $data['page'] = "Dashboard";
    ...
    public function cari_user()
    {
        ...
        $this->load->view('v_template',$data);
        $this->load->view('admin/dashboard/v_cari', $data);
        $this->load->view('v_footer');
    }
    ...
    public function block() 
    {
        ...
        $this->m_dashboard->block($id,$data);
    ...
    {   
        ...
        $this->m_dashboard->aktif($id,$data);
    ...
    public function detail_user()
    {
        ...
        $data['detail'] = $this->m_dashboard->ambil_user($id_user);
        $data['result'] = $this->m_dashboard->ambil_admin($id);
    ...
    public function ambil_user() 
    {
        ...
        $this->load->view('v_template',$data);
        $this->load->view('admin/dashboard/v_user_edit', $data);
        $this->load->view('v_footer');
    }
    ...
    public function proses_edit_foto() {
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('admin/dashboard/'); //jika gagal maka akan ditampilkan form upload
            }
            else
            {
